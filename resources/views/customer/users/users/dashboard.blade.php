                        ...
                        <div class="row">
                            <div class="col-8 col-lg-3 offset-2">
                                <div class="h-100 d-flex flex-row justify-content-center align-items-center">
                                    <div class="text-center mr-2">{{ trans('users.trainer.social_share_qr') }}</div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="h-100 d-flex flex-row justify-content-center align-items-center">
                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('anonymous.trainers.show', ['trainer' => $user['identifier']])) }}&t={{ urlencode(trans('users.trainer', ['friend_code' => $user['friend_code']['formated']])) }}" class="btn btn-primary mr-2" target="_blank" rel="noopener"><i class="fab fa-facebook"></i></a>
                                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('anonymous.trainers.show', ['trainer' => $user['identifier']])) }}&text={{ urlencode(trans('users.trainer', ['friend_code' => $user['friend_code']['formated']])) }}&via=pkmn_friends" class="btn btn-default btn-twitter mr-2 text-white" target="_blank" rel="noopener"><i class="fab fa-twitter"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row mb-0">
                            <div for="alert" class="col-4 col-form-label text-sm-center">share your QrCode on your live stream</div>
                            <div class="col-6">
