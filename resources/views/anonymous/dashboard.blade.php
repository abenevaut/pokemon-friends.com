...
<head>
    ...
    <title>Gameforest Bootstrap Gaming Theme</title>
    <!-- css: theme -->
    ...
    <div class="site-content" role="main">
        <section class="p-0 overflow-hidden">
            <div class="owl-carousel" ya-carousel="autoplay: true;height: true">
                ...
                <div class="owl-carousel-item">
                    <img src="https://img.youtube.com/vi/BhTkoDVgF6s/maxresdefault.jpg" ya-style="opacity: .3" alt="">
                    <div class="owl-caption">
                        <div class="owl-caption-container">
                            <h1 class="owl-title">For Honor: The Berserker</h1>
                            <p class="owl-text">Enter the chaos of a raging war as a bold knight, brutal viking, or mysterious samurai, three of <br>the greatest warrior legacies.</p>
                            <a class="btn btn-primary btn-lg btn-rounded" href="game-post.html" role="button">View Game</a>
                            <a class="btn btn-outline-light btn-lg btn-rounded ml-2" href="https://www.youtube.com/watch?v=zFUymXnQ5z8" ya-lightbox role="button">Watch Trailer</a>
                        </div>
                    </div>
                </div>
                <div class="owl-carousel-item">
                    <img src="https://static.giantbomb.com/uploads/original/0/2840/2495891-the-division_2013_06-10-13_008.jpg" ya-style="opacity: .35" alt="">
                    <div class="owl-caption">
                        <div class="owl-caption-container">
                            <h1 class="owl-title">Tom Clancy's The Division</h1>
                            <p class="owl-text">An online-only open-world shooter-RPG from Ubisoft Massive set in a chaotic New York City <br>that is wrought by disease.</p>
                            <a class="btn btn-primary btn-lg btn-rounded" href="game-post.html" role="button">View Game</a>
                            <a class="btn btn-outline-light btn-lg btn-rounded ml-2" href="https://www.youtube.com/watch?v=yPq_NVi-TC4" ya-lightbox role="button">Watch Trailer</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom">
            <div class="container d-flex flex-column flex-md-row">
                <div class="order-2 order-md-1">
                    ...
                    <p class="footer-copyright">&copy; 2020 <a href="https://themeforest.net/item/gameforest-responsive-gaming-html-theme/5007730" target="_blank">Gameforest</a>. Designed and built by <a href="https://yakuthemes.com" target="_blank">yakuthemes</a>. All rights reserved.</p>
                </div>
