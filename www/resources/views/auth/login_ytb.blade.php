...
{{--                     style="background-color:transparent;box-shadow:none;"--}}
                >
                    <div class="card-body p-3">
                        ...
                        <a href="{{ route('login_provider', ['provider' => \pkmnfriends\Infrastructure\Domain\Users\ProvidersTokens\ProvidersInterface::GOOGLE]) }}" class="btn btn-social btn-block btn-google-plus"><i class="fab fa-google mr-1"></i>{{ trans('auth.login_google') }}</a>
                        <a href="{{ route('login_provider', ['provider' => \pkmnfriends\Infrastructure\Domain\Users\ProvidersTokens\ProvidersInterface::TWITTER]) }}" class="btn btn-social btn-block btn-twitter"><i class="fab fa-twitter mr-1"></i>{{ trans('auth.login_twitter') }}</a>
